        ...
        for search_result in spectrum_query.iter('{http://regis-web.systemsbiology.net/pepXML}search_result'):
            for search_hit in search_result.iter('{http://regis-web.systemsbiology.net/pepXML}search_hit'):
                ...
                for modification_info in search_hit.findall(
                        '{http://regis-web.systemsbiology.net/pepXML}modification_info'):
                    for mod_aminoacid_mass in modification_info.iter(
                            '{http://regis-web.systemsbiology.net/pepXML}mod_aminoacid_mass'):
                ...
                for alternative_protein in search_hit.iter(
