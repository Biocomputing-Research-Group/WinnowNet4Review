...
def report_output(config_dict,
    ...
    # protein FDR
    protein_fdr = 0.0
    FDR_parameter = float(1 + (1 / 2))
    if float(total_proteins_after_filtering) != 0:
        protein_fdr = divide(float(decoy_proteins_after_filtering)*FDR_parameter, float(total_proteins_after_filtering))
